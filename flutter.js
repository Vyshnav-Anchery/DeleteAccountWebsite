...
(function () {
  ...
  class FlutterServiceWorkerLoader {
    ...
    loadServiceWorker(settings) {
      ...
      const {
        ...
        serviceWorkerUrl = `${baseUri}/DeleteAccountWebsite/flutter_service_worker.js?v=${serviceWorkerVersion}`,
        timeoutMillis = 4000,
      } = settings;
  ...
  class FlutterEntrypointLoader {
    ...
    async loadEntrypoint(options) {
      const { entrypointUrl = `${baseUri}DeleteAccountWebsite/main.dart.js`, onEntrypointLoaded } =
        options || {};
